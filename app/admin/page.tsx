        ...
        <div className="bg-gradient-to-r from-indigo-950 to-indigo-800 px-6 py-5 flex-shrink-0">
          <div className="flex items-start justify-between">
            <div>
              ...
              {!!(f["Email"] as string) && <div className="text-indigo-400 text-xs mt-0.5">{f["Email"] as string}</div>}
            </div>
                  ...
                  {touchpoints.map(tp => {
                    ...
                    return (
                      <div key={tp.id} className="bg-white border border-gray-100 rounded-xl p-4">
                        ...
                        {!!(tf["Notes"] as string) && <p className="text-sm text-gray-700 leading-relaxed">{tf["Notes"] as string}</p>}
                        {!!(tf["Action Item"] as string) && (
